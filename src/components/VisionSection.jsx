...
const VisionSection = () => {
  return (
    <section className="collage-section">
      ...
      {/* Background Layer */}
      <img src={bgImg} alt="Vision Background" className="collage-bg parallax-bg" data-speed="0.3" />
      ...
      <div className="collage-container reverse">
        ...
        <div className="collage-text-content">
          <span className="luxury-sub animate-child" style={{color: '#D4AF37'}}>Our Vision</span>
          <h2 className="luxury-head animate-child">Reshaping the<br/>Landscape</h2>
